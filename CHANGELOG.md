...
## [Unreleased]
[Unreleased]: https://bitbucket.org/atlassian/jira-performance-tests/branches/compare/release-0.0.1%0Dmaster

### Fixed
- Add the missing virtual users main class. See #1.

## [0.0.1] - 2018-08-08
[0.0.1]: https://bitbucket.org/atlassian/jira-performance-tests/branches/compare/release-0.0.1%0Dinitial-commit

### Added
- High-level test API migrated from [JPT submodule].
- [README.md](README.md).
